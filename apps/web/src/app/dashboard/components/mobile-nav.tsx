...
export function MobileNavigation() {
  ...
  return (
    <nav
      className="fixed inset-x-3 bottom-3 z-40 flex min-h-16 items-center justify-around rounded-2xl border border-border bg-[#111113]/95 px-2 pb-[env(safe-area-inset-bottom)] backdrop-blur-xl lg:hidden"
