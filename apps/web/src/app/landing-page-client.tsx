...
export function LandingPageClient({ hasSession }: { hasSession: boolean }) {
  ...
  return (
    <div className="min-h-dvh bg-background text-text-primary selection:bg-accent-soft selection:text-accent transition-colors duration-300">
      ...
      <section className="relative pt-20 pb-20 md:pt-28 md:pb-28">
        <div className="mx-auto max-w-5xl px-6 text-center lg:px-8">
          ...
          <h1 className="mt-8 font-serif text-4xl font-medium tracking-tight text-text-primary sm:text-6xl lg:text-7xl leading-[1.1]">
            Your life and studies, <br className="hidden sm:inline" />
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base text-text-secondary sm:text-lg leading-relaxed font-normal">
            Zury turns scattered lectures, exam deadlines, and study plans into
            an actionable daily rhythm. Built to work seamlessly across desktop
            & mobile, even on slow or unreliable networks.
          </p>
          ...
          <div
            id="preview"
            className="mt-16 sm:mt-24 relative mx-auto max-w-5xl rounded-3xl border border-border bg-canvas-raised/95 p-3 sm:p-4 shadow-[0_32px_96px_rgba(0,0,0,0.2)] dark:shadow-[0_32px_96px_rgba(0,0,0,0.9)] backdrop-blur-2xl transition-colors duration-300"
          >
            {/* Top Toolbar */}
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] text-text-tertiary">
                              10:00 AM - 11:30 AM • Lecture Hall B
                            </p>
                          </div>
                        </div>
                        <span className="rounded-lg bg-accent-soft px-2.5 py-1 text-[10px] font-semibold text-accent">
                          Up Next
                        </span>
                      </div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-xs font-medium text-text-secondary">
                              Algorithms Exam Review Session
                            </p>
                            <p className="text-[11px] text-text-tertiary">
                              2:00 PM - 4:00 PM • Campus Library
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="rounded-2xl border border-border bg-surface p-5 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="mt-3 text-xs leading-relaxed text-text-secondary">
                        "You have two open hours after your lecture. I drafted a
                        study block for your upcoming Algorithms quiz."
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between border-b border-border pb-4">
                    <div>
                      <h3 className="font-serif text-xl font-medium text-text-primary">
                        Weekly Schedule & Study Plan
                      </h3>
                      <p className="text-xs text-text-tertiary mt-1">
                        Realistic workload allocation based on active course
                        commitments
                      </p>
                    </div>
                    <span className="rounded-xl border border-border bg-surface-hover px-3 py-1.5 text-xs text-text-secondary font-medium">
                      Auto-balanced
                    </span>
                  </div>
              ...
              {activeTab === "offline" && (
                <div className="rounded-2xl border border-border bg-surface p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="font-serif text-xl font-medium text-text-primary">
                      Offline with Dignity
                    </h3>
                  </div>
                  <p className="mt-2 text-xs text-text-secondary max-w-xl">
                    When network connectivity drops, Zury keeps running without
                    broken error popups. All notes, calendar entries, and study
                    plans stay cached locally.
                  </p>
                  ...
                  <div className="mt-4 space-y-3">
                    ...
                    <div className="flex justify-start">
                      <div className="rounded-2xl border border-border bg-canvas-raised px-4 py-3 text-xs text-text-primary max-w-lg leading-relaxed">
                        You have a Computer Science lecture at 9:00 AM, followed
                        by 2 free hours before your afternoon lab.
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section
        id="features"
        className="border-t border-border py-24 bg-canvas-raised/40"
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="max-w-2xl text-left">
            ...
            <p className="mt-4 text-sm text-text-secondary leading-relaxed">
              No bloated dashboards or complicated setups. Zury brings clarity
              to your academic workflow through four core operational pillars.
            </p>
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="rounded-2xl border border-border bg-surface p-6 transition hover:border-accent/40 hover:shadow-lg">
              ...
              <h3 className="mt-5 font-serif text-xl font-medium text-text-primary">
                Today Briefing
              </h3>
              <p className="mt-2 text-xs leading-relaxed text-text-secondary">
                Open straight to what's actionable right now. See your daily
                lectures, study goals, and urgent priorities at a single glance.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-border bg-surface p-6 transition hover:border-accent/40 hover:shadow-lg">
              ...
              <p className="mt-2 text-xs leading-relaxed text-text-secondary">
                Allocate study time dynamically around your existing classes.
                Zury balances workload so Friday nights stay free.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-border bg-surface p-6 transition hover:border-accent/40 hover:shadow-lg">
              ...
              <p className="mt-2 text-xs leading-relaxed text-text-secondary">
                Network drops shouldn't stop your study. All schedules and notes
                are cached locally, syncing automatically when reconnected.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-border bg-surface p-6 transition hover:border-accent/40 hover:shadow-lg">
              ...
              <p className="mt-2 text-xs leading-relaxed text-text-secondary">
                An AI companion that operates quietly in plain
                language—suggesting room for study sessions without chatbot
                noise.
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-4 text-sm text-text-secondary leading-relaxed">
                Zury is engineered for extreme performance and low bandwidth
                usage. Internal synchronization architecture, edge caching, and
                model routing remain completely invisible so you can focus
                strictly on academic success.
              </p>

              <div className="mt-8 space-y-4">
                <div className="flex items-start gap-4">
                  <div className="size-6 shrink-0 grid place-items-center rounded-lg bg-accent-soft text-accent text-xs">
                    ✓
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-text-secondary mt-0.5">
                      Instant load times with IndexedDB client caching.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-text-secondary mt-0.5">
                      Optimized payloads designed for 3G/4G connectivity across
                      Africa.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-text-secondary mt-0.5">
                      Translates course outlines and lecture schedules into
                      prioritized tasks.
                    </p>
                  </div>
                </div>
      ...
      <footer className="border-t border-border bg-canvas-raised py-16">
        <div className="mx-auto max-w-5xl px-6 text-center lg:px-8">
          ...
          <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row text-xs text-text-tertiary">
            <div className="flex items-center gap-2">
              <span className="grid size-5 place-items-center rounded bg-accent text-[10px] font-bold text-accent-foreground">
                Z
              </span>
